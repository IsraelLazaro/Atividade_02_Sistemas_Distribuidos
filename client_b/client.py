...
SERVER_HOST = '127.0.0.1'  # IP do servidor central
SERVER_PORT = 1234         # Porta do servidor central
CLIENT_PORT = 1236         # Porta para receber downloads
PUBLIC_DIR = os.path.join(os.path.dirname(__file__), 'public')


def start_file_server():
    """Inicia o servidor de arquivos do cliente"""
...
def join_network(server_sock, client_ip):
    """Registra o cliente no servidor central"""
...
def share_files(server_sock):
    """Compartilha lista de arquivos com o servidor"""
...
def download_file(filename, address):
    """Baixa um arquivo de outro cliente de forma simples"""
    try:
...
def leave_network(server_sock):
    """Desconecta do servidor central"""
